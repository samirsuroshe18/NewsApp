...
import `in`.smartdwell.newsapp.presentation.Dimens.IconSize
        ...
        TextField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    else Color(0xFF4E4B66) // Your current body color
                )
            },
            placeholder = {
                Text(
            ...
            colors = TextFieldDefaults.colors(
                ...
                errorContainerColor = if (isSystemInDarkTheme())
                    MaterialTheme.colorScheme.surfaceVariant
                else Color.White,
...
fun SearchBarLightPreview() {
    NewsAppTheme(darkTheme = false, dynamicColor = false) {
...
fun SearchBarDarkPreview() {
    NewsAppTheme(darkTheme = true, dynamicColor = false) {
        SearchBar(text = "", onValueChange = {}, readOnly = false) {}
    }
}